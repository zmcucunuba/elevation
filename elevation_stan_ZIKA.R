...
dat  <- readRDS('data/elevation_infected_zika.RDS')
...
write.csv(results, 'results_final_zika_corrected.csv')
...
estimated_pars <- read_csv("results_final_zika_corrected.csv")
